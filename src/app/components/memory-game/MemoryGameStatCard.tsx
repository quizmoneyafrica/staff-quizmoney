...
interface IMemoryGameStatCardProps {
  title: string;
...
const MemoryGameStatCard: React.FunctionComponent<IMemoryGameStatCardProps> = (
  props,
) => {
  const {
    title,
...
export default MemoryGameStatCard;

export const MemoryGameStatCardLoading: React.FunctionComponent = () => {
  return (
