  ...
  return (
    <>
      <div className="bg-primary-50 grid h-screen w-full grid-cols-1 p-4 lg:h-full lg:px-10 ">
          ...
          <Flex align="center" justify="between">
            ...
            {currentIndex === slides.length - 1 ? null : (
              <button
                ...
                className="text-primary-500 underline lg:hidden"
              >
                Skip
              </button>
            )}
            ...
            {slides.map((slide, index) => (
              <SwiperSlide key={index}>
                <div className="flex-col items-center justify-between px-4 pt-4 text-center">
                  ...
                  <p className="font-text mx-auto text-gray-600 md:max-w-[60%]">
                    {slide.description}
                  </p>
                </div>
              </SwiperSlide>
        ...
        <div className="mt-6 flex flex-col items-center justify-center gap-10 pb-10 ">
