...
interface INumberGuessingStatCardProps {
  title: string;
...
const NumberGuessingStatCard: React.FunctionComponent<
  INumberGuessingStatCardProps
> = (props) => {
  const {
    title,
    children,
...
export default NumberGuessingStatCard;

export const NumberGuessingStatCardLoading: React.FunctionComponent = () => {
  return (
